...
public final class EObjectValueRenderer extends DefaultDataValueRenderer {
    /**
    ...
    public static final class Factory extends AbstractDataValueRendererFactory {
        ...
        public DataValueRenderer createRenderer(final DataColumnSpec colSpec) {
            return new EObjectValueRenderer();
        }
    }
     ...
     */
    @Deprecated
    public static final EObjectValueRenderer INSTANCE = new EObjectValueRenderer();
...
//        }
    	if (value instanceof EObjectValue) {
    		String s = ((EObjectValue)value).getValue().toString();
    		super.setValue(s);
    	} else {
    		super.setValue(value);
    	}
