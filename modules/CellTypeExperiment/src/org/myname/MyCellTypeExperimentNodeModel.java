...
/**
 * This is the model implementation of MyCellTypeExperiment.
 * 
 *
 * @author Jiri Vinarek
 */
public class MyCellTypeExperimentNodeModel extends NodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(MyCellTypeExperimentNodeModel.class);
    ...
    private final SettingsModelIntegerBounded m_count =
        new SettingsModelIntegerBounded(MyCellTypeExperimentNodeModel.CFGKEY_COUNT,
     ...
     */
    protected MyCellTypeExperimentNodeModel() {
...
//	            , new EObjectCell(EXTLibraryFactory.eINSTANCE.createBook())
            ...
            MyStore.map.put(Integer.toString(i), b);
