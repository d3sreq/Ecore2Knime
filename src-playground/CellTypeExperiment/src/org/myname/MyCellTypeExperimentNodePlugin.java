 ...
 * @author Jiri Vinarek
 */
public class MyCellTypeExperimentNodePlugin extends Plugin {
    // The shared instance.
    private static MyCellTypeExperimentNodePlugin plugin;

    /**
     * The constructor.
     */
    public MyCellTypeExperimentNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MyCellTypeExperimentNodePlugin getDefault() {
        return plugin;
    }
